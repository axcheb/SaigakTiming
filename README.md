...
При автоматическом запуске участников на экране отображается таймер на котором сначала идёт обратный отсчёт в секундах, а затем отображается время, отведенное на прохождение спец. этапа.
Чуть ниже расположены 3 кнопки: Следующий, Пауза/Возобновить, В конец списка.

* Следующий - стартует следующий участник. Обратный отсчёт начинается с -5 секунд.
* Пауза - приостанавливает запуск участников. Если кнопка пауза была нажата пока шел обратный отсчёт, то следующим будет стартовать то же участник, для которого шел обратный отчёт. Если время участника уже началось, то предполагается, что он уже на дистанции, и при нажатии кнопки Возобновить, обратный отсчёт пойдёт для следующего участника.
* В конец списка - перемещает текущего участника в конец списка **в рамках текущего СУ**. Если в рамках соревнования участник должен проехать несколько СУ, то на следующем СУ он станется на своей позиции, т.е НЕ в конце списка. Если выйти из режима соревнования и запустить соревнование заново, то участник останется на своей позиции, т.е НЕ в конце списка.   
